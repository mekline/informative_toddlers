...
# utterance x gender bar graph - something is wrong with this graph but that is so not my problem right now
...
ggplot(h1_animacy, aes(x = age_in_months, fill = utterance_type)) +
  geom_bar(position = "dodge") +
  facet_wrap(~ animacy)+
