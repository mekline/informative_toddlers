...
trial_data_h1 <- trial_data_toanalyze %>%
  ...
  select(session_id, child_id, stimulus_condition, trial_num, stimulus_set, uninformative_entities, response_exact_utterance, response_included_informative, response_included_uninformative, age_in_days, gender) %>% 
