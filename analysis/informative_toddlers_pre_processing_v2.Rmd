...
Also, since I keep all the raw data on Dropbox instead of GitHub (subject to change), **you need to insert the specific path as it appears on your computer anytime you want to read or write as csv**.

```{r set and check directory}
# set directories
general_location = "C:/Users/babyg/Dropbox/MIT Work Files/ECCL/Informative Toddlers/Data/data/v2_oct2024/v2_oct2024_first_90_kids"
...
write.csv(all_sessions, "C:/Users/babyg/Dropbox/MIT Work Files/ECCL/Informative Toddlers/Data/data/v2_oct2024/v2_oct2024_first_90_kids/processed_data/v2_oct2024_step1/v2_oct2024_step1_all-responses-identifiable.csv")
```


## Step 3

If this isn't your first batch of data coding, use this chunk to fill in the new all-responses file with the coded version of the most recent all-responses file!

```{r fill in all-responses}

```


At this point you should STOP running the script, go apply the session-level inclusion criteria, and come back (unless you did that before you even started).
...
updated_all_sessions_file <- read_csv("C:/Users/babyg/Dropbox/MIT Work Files/ECCL/Informative Toddlers/Data/data/v2_oct2024/v2_oct2024_first_90_kids/processed_data/v2_oct2024_step2_TOCODE/v2_oct2024_step2_all-sessions.csv")
...
write.csv(all_orders, "C:/Users/babyg/Dropbox/MIT Work Files/ECCL/Informative Toddlers/Data/data/v2_oct2024/v2_oct2024_first_90_kids/processed_data/v2_oct2024_step2_TOCODE/v2_oct2024_step2_all-orders_TOCODE.csv")

```

If this isn't your first batch of data coding, use this chunk to fill in the new all-orders file with the CODED version of the most recent all-order file!

```{r fill in all orders file}
