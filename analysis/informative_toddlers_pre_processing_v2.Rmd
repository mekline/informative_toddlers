...
# set directories
general_location = "C:/Users/babyg/Dropbox/MIT Work Files/ECCL/Informative Toddlers/Data/data/v2_sept2024/v2_sept2024_first_90_kids"

raw_location = paste0(general_location, "/raw_data")
processed_location = paste0(general_location, "/processed_data/v2_sept2024_step1/framedata")
...
copy_and_rename <- function(src_dir, dst_dir) {
  ...
  for (file in files) {
    ...
    out_name <- sub("Tell-Me-About-It-Too-", "v2_sept2024_step1", file_name)
...
all_sessions <- `v2_sept2024_step1_all-responses-identifiable`
...
write.csv(all_sessions, "C:/Users/babyg/Dropbox/MIT Work Files/ECCL/Informative Toddlers/Data/data/v2_sept2024/v2_sept2024_first_90_kids/processed_data/v2_sept2024_step1/v2_sept2024_step1_all-responses-identifiable.csv")
```
...
updated_all_sessions_file <- read_csv("C:/Users/babyg/Dropbox/MIT Work Files/ECCL/Informative Toddlers/Data/data/v2_sept2024/v2_sept2024_first_90_kids/processed_data/v2_sept2024_step2_TOCODE/v2_sept2024_step2_all-responses.csv")
...
for (i in seq_along(codable_sessions)) {
  codable_sessions[i] <- paste0("v2_sept2024_step2_", codable_sessions[i], "_frames")
}
...
write.csv(all_orders, "C:/Users/Lia Washington/Downloads/ECCL/ECCL/Informative Toddlers/Data/data/v1_jan2024_complete_dataset/processed_data/v1_jan2024_step2_TOCODE/v1_jan2024_step2_all-orders_TOCODE.csv")
