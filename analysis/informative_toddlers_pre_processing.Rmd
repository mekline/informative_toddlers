...
processed_location = paste0(general_location, "/processed_data/step1/")
...
write.csv(all_sessions, "v1jan2024-step2_all-responses-identifiable.csv")

# relocate the file to the appropriate folder
current_path = "C:/Users/babyg/Desktop/v1jan2024-step2_all-responses-identifiable.csv"
step2_location = paste0(general_location, "/processed_data/step2_TOCODE/v1jan2024-step2_all-responses-identifiable.csv")
file.rename(from = current_path, to = step2_location)
```
...
updated_all_sessions_file <- read_csv("C:/Users/babyg/Documents/data/processed_data/step2_TOCODE/v1jan2024-step2_all-responses-identifiable.csv")
...
write.csv(all_orders, "v1jan2024-step2_all_orders_TOCODE.csv")
