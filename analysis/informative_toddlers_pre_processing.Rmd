...
# set directories
general_location = "C:/Users/Lia Washington/Downloads/ECCL/ECCL/Informative Toddlers/Data/data/v1_jan2024_complete_dataset"

raw_location = paste0(general_location, "/raw_data/framedata")
processed_location = paste0(general_location, "/processed_data/v1_jan2024_step1/framedata")
...
copy_and_rename <- function(src_dir, dst_dir) {
  ...
  for (file in files) {
    ...
    out_name <- sub("Tell-Me-About-It-", "v1_jan2024_step1", file_name)
...
write.csv(all_sessions, "C:/Users/babyg/Dropbox/MIT Work Files/ECCL/Informative Toddlers/Data/data/v1_jan2024_complete_dataset/processed_data/v1_jan2024_step2_TOCODE/v1_jan2024_step2_all-sessions.csv")
```
...
updated_all_sessions_file <- read_csv("C:/Users/Lia Washington/Downloads/ECCL/ECCL/Informative Toddlers/Data/data/v1_jan2024_complete_dataset/processed_data/v1_jan2024_step3_CODED/v1_jan2024_step3_all-sessions.csv")
...
for (i in seq_along(codable_sessions)) {
  codable_sessions[i] <- paste0("v1_jan2024_step1_", codable_sessions[i], "_frames")
}
